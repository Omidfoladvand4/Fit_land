...
`,_=({image:e=`/placeholder-image.jpg`,title:t=`NCY تیشرت زنانه`,price:n=16e4,originalPrice:_=2e5,rating:v=4.5,colors:y=[`#000000`,`#b5651d`,`#ffffff`],sizes:b=[`XL`,`L`,`S`,`2XL`,`M`]})=>{let x=e=>{let t=[],n=Math.floor(e),i=e%1>=.5;for(let e=0;e<n;e++)t.push(`★`);for(i&&t.push(`★`);t.length<5;)t.push((0,r.jsx)(`span`,{children:`★`},t.length));return t},S=_&&_>n;return(0,r.jsxs)(i,{children:[(0,r.jsxs)(a,{children:[(0,r.jsx)(`img`,{src:e,alt:t}),(0,r.jsx)(o,{children:b.slice(0,5).map((e,t)=>(0,r.jsx)(s,{children:e},t))})]}),(0,r.jsxs)(c,{children:[(0,r.jsx)(l,{children:x(v)}),(0,r.jsx)(u,{children:t}),(0,r.jsx)(d,{children:(e=>{if(!e||e.length===0)return``;let t=[...e].sort((e,t)=>{let n=[`XS`,`S`,`M`,`L`,`XL`,`2XL`,`3XL`];return n.indexOf(e)-n.indexOf(t)});return`از سایز ${t[0]} تا ${t[t.length-1]}`})(b)}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(p,{children:[n.toLocaleString(),` تومان`]}),S&&(0,r.jsxs)(m,{children:[_.toLocaleString(),` تومان`]})]}),(0,r.jsxs)(h,{children:[y.slice(0,3).map((e,t)=>(0,r.jsx)(g,{$color:e},t)),y.length>3&&(0,r.jsxs)(g,{$color:`#e5e7eb`,style:{display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:`8px`,fontWeight:`bold`,color:`#6b7280`},children:[`+`,y.length-3]})]})]})]})};export{n,_ as t};